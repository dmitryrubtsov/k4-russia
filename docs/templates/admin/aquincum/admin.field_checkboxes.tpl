<div class="checkboxes">
	...
	<a href="#" onclick="checkElement{$Field.name}('{$Config.AddFormName}','checked');return false;">{$lang.admin.checkAll}</a>
	&nbsp;|&nbsp;
	<a href="#" onclick="checkElement{$Field.name}('{$Config.AddFormName}','');return false;">{$lang.admin.uncheckAll}</a>
	<br />
