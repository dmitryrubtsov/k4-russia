                ...
                <tr>
                    ...
                    <td>
                        ...
                        {rdelim}
                            ...
                            <img src="{$HOST}{$Config.MainImageFolder}{$Config.adminImageFolder}{$Config.generalImageFolder}close_ico.png" width="20" height="20" title="{$lang.admin.deleteImage}" style="width: 20px;top:0px;  margin-left: 10px;"/>
                        </a>
                    </td>
                </tr>
    {/foreach}
