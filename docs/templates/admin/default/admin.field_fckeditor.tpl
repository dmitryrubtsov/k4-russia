...
<div id="{$Field.name}LoadEditor"><input type="button" value="{$lang.admin.loadEditor}" onclick="{$Field.name}LoadEditor(true);return false;" /></div>
{/if}
...
<script language="javascript">{$Field.name}LoadEditor(false);</script>
{/if}