<?php
    ...
    {
        $PageTitle = '$language["admin"]["projectGroups"]." :: ".$Item["' . $TabFields['ai']['title'] . '"];';
        //$RowItem = getRowByField($_SQL_TABLE['article_info'], $WorkTableKeyFieldName, $_GET[$WorkTableKeyVarName]);
    }
    else
    {
        $PageTitle = '$language["admin"]["projectGroups"];';
        $AloneMode = $GlobPart;
        ...
        $Query['Fields'] = "a.*, ai.*";
        $Query['TabOrder'] = "a.";
        $Query['Where'] = "a.article_type_id = 9";
    ...
    $_SQL_TABLE_FIELDS[$GlobPart] = $GeneratedLangArr + array(
        ...
        */
        ...
        'image_id' => array(
            ...
            'title' => $language['admin']['groupImage'],
            'useInAddForm' => 'y',
            'noResize' => 'y',
            //'notUsedInDB' => 'y',
            'useFTP' => 'y',
