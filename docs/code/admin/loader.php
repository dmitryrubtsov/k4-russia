...
$adminTamplate = array(
    ...
    'name' => 'aquincum',
    'folderName' => 'aquincum',
    'smartyTemplate' => 'admin.main_template.tpl',
);
...
{
    	define('__CFG_THEME', $adminTamplate['folderName']);
}
else
{
...
$tpl->assign("templatePass", str_replace(__CFG_CORE_PATH, '', __CFG_PATH_TEMPLATE.$adminTamplate['folderName'].'/'));
