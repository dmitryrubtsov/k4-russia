<?
	...
	if(!$pct->is_cached($CONFIG['ModulesFolder'].$CONFIG['BlocksFolder'].'block.slider_production_page.tpl'))
	{
	...
	$pct->setBlock("SliderProductionPage", $tpl->fetch($CONFIG['ModulesFolder'].$CONFIG['BlocksFolder'].'block.slider_production_page.tpl'));
