<?
	...
	if(!$pct->is_cached($CONFIG['ModulesFolder'].$CONFIG['BlocksFolder'].'block.header_main_page.tpl'))
	{
	...
	$pct->setBlock("HeaderMainPage", $pct->fetch($CONFIG['ModulesFolder'].$CONFIG['BlocksFolder'].'block.header_main_page.tpl'));
