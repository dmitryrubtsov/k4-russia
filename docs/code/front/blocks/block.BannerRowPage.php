<?
	...
	if(!$pct->is_cached($CONFIG['ModulesFolder'].$CONFIG['BlocksFolder'].'block.banner_row_page.tpl'))
	{
	...
	$pct->setBlock("BannerRowPage", $tpl->fetch($CONFIG['ModulesFolder'].$CONFIG['BlocksFolder'].'block.banner_row_page.tpl'));
