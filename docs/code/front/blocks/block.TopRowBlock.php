<?
	...
	if(!$pct->is_cached($CONFIG['ModulesFolder'].$CONFIG['BlocksFolder'].'block.top_row_block.tpl'))
	{
	...
	$pct->setBlock("TopRowBlock", $tpl->fetch($CONFIG['ModulesFolder'].$CONFIG['BlocksFolder'].'block.top_row_block.tpl'));
