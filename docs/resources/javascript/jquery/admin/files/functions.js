$(function() {
	...
	$(function() {
	    $('#checkAll tbody tr td.check input[type=checkbox]').change(function() {
	...
	$("#uploader1").pluploadQueue({
		...
		url : 'http://vd.recreator.ru/1961/index.php?mode=image_uploader',
		max_file_size : '100kb',
		unique_names : true,
		filters : [
	...
	$("select, .styled, input:radio, .dataTables_length select").uniform();
